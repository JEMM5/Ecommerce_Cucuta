...
<sf:form id="regProd" action="${pageContext.request.contextPath}/modificarProducto/guardar" enctype="multipart/form-data" method="post" commandName="producto">
  <b style="color:red;"><c:out value="${mensajeRegistro}"/></b>
<table class="tablaProducto">
<input type="hidden" name="webid" value="${productoMod.webid}">
  <tr>
    <td>Nombre: </td>
    <td>
      <input type="text" name="nombreProd" value="${productoMod.nombre}"/>
    </td>
  <tr>  
  <tr>
    <td>Precio: </td>
    <td>
      <input type="text" name="precioProd" value="${productoMod.precio}"/>
    </td>
  </tr>
  <tr>
    <td>Stock: </td>
    <td>
      <input type="text" name="stockProd" value="${productoMod.stock}"/>
    </td>
  </tr>  
  <tr>
    <td>Empresa: </td>
  ...
  <tr>
    <td>Descripci�n: </td>
    <td>
      <textarea cols="35" rows="5" name="descripcion">${productoMod.descripcion}</textarea> 
    </td>
  </tr>
</table>
...
<br/><br/>
<!-- <form> -->
	<input type="hidden" name="imagen1" value="${productoMod.img1}" />
	<input type="hidden" name="imagen2" value="${productoMod.img2}" />
	<input type="hidden" name="imagen3" value="${productoMod.img3}" />
	<input type="hidden" name="imagen4" value="${productoMod.img4}" />
	<input type="hidden" name="imagen5" value="${productoMod.img5}" />
  ...
  <div class="image-upload">
    ...
    <div class="divCamara">
      ...
      <label id="fileLabel1" class="camara">
	      <c:if test='${productoMod.img1 eq ""}'>
	      	Elegir imagen
	      </c:if>
	      <c:if test='${productoMod.img1 != ""}'>
	      	<c:out value="${productoMod.img1}" />
	      </c:if>
      </label>
    </div>
  </div>
  ...
  <div class="image-upload">
    ...
    <div class="divCamara">
      ...
      <label id="fileLabel2" class="camara">
	      <c:if test='${productoMod.img2 eq ""}'>
	      	Elegir imagen
	      </c:if>
	      <c:if test='${productoMod.img2 != ""}'>
	      	<c:out value="${productoMod.img2}" />
	      </c:if>
	  </label>
    </div>
  </div>
  ...
  <div class="image-upload">
    ...
    <div class="divCamara">
      ...
      <label id="fileLabel3" class="camara">
	      <c:if test='${productoMod.img3 eq ""}'>
	      	Elegir imagen
	      </c:if>
	      <c:if test='${productoMod.img3 != ""}'>
	      	<c:out value="${productoMod.img3}" />
	      </c:if>
	  </label>
    </div>
  </div>
  ...
  <div class="image-upload">
    ...
    <div class="divCamara">
      ...
      <label id="fileLabel4" class="camara">
	      <c:if test='${productoMod.img4 eq ""}'>
	      	Elegir imagen
	      </c:if>
	      <c:if test='${productoMod.img4 != ""}'>
	      	<c:out value="${productoMod.img4}" />
	      </c:if>      
	      </label>
    </div>
  </div>
  ...
  <div class="image-upload">
    ...
    <div class="divCamara">
      ...
      <label id="fileLabel5" class="camara">
      <c:if test='${productoMod.img5 eq ""}'>
      	Elegir imagen
      </c:if>
      <c:if test='${productoMod.img5 != ""}'>
      	<c:out value="${productoMod.img5}" />
      </c:if>
	  </label>
    </div>
  </div>
  ...
  <div class="col-xs-9">
    <br/>
    Nuevo <input type="checkbox" name="nuevo" value="" <c:if test='${productoMod.nuevo eq "0"}'>checked="checked"</c:if> >
    <br/>
    Recomendado <input type="checkbox" name="recomendado" value="" <c:if test='${productoMod.recomendado eq "0"}'>checked="checked"</c:if>>
    <br/>
    Visible <input type="checkbox" name="visible" value="" <c:if test='${productoMod.visible eq "0"}'>checked="checked"</c:if>>
    <br/>
